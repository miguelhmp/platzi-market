...
public class ProductController {
    ...
    @GetMapping("/")
    @Operation(summary = "Get all supermarket producs", description = "This method will return all supermarket producs in ascendant order, and a 200 as reponse code on sucessfully operation")
